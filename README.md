...
- 🖥️ **Темная тема** — черно-белый минималистичный интерфейс
- ⚙️ **Автонастройка** — один админ-ключ для всего класса
- 🏫 **Для образования** — идеально для школьных проектов и уроков
...
┌─────────────────────────────────────┐
│  📁 Test_Data_Folder              │ ← ПКМ → Скачать папку
│  ├─ 📄 data1.csv                 │
│  ├─ 📁 Data_TEST                 │
│  │  └─ 📄 test2.py              │ ← ПКМ → Скачать файл
│  └─ ...                           │
└─────────────────────────────────────┘
```
...
pip install PyQt6 requests pathlib
...
# 5. Выберите файлы → "Скачать этот элемент"
```
